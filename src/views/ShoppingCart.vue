        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="proceed-checkout" align="left">
                                <ul>
                                    <li class="subtotal">ID Transaction <span>#LMS123</span></li>
                                    <li class="subtotal mt-3">Subtotal <span>Rp. {{totalHarga}} </span></li>
                                    <li class="subtotal mt-3">Pajak 10%<span>{{tambahPajak}}</span></li>
                                    <li class="subtotal mt-3">Total Biaya <span>Rp. {{totalBiaya}}</span></li>
                                    <li class="subtotal mt-3">Bank Transfer <span>BNI</span></li>
                                    <li class="subtotal mt-3">No. Rekening <span>2209 2000 9991</span></li>
                                    <li class="subtotal mt-3">Nama Penerima <span>Laili Septiandi</span></li>
                                </ul>
...
export default {
  ...
  methods: {
    ...
    // },
      ...
      // mencari item id untuk di hapus
      ...
      // mencocokan idx dengan id storage
  ...
  checkout(){
    ...
    axios
      .post(
        "http://testdev.my.id/api/checkout", 
        checkoutData 
        )
